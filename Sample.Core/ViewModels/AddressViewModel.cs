...
namespace Sample.Core.ViewModels
{
    public class AddressViewModel : BaseViewModel
    {
        ...
        public string CityLabel => this["CityLabel"];
        public string StateLabel => this["StateLabel"];
        public string ZipLabel => this["ZipLabel"];
        public string CountryLabel => this["CountryLabel"];
        public string SaveButton => this["SaveButton"];
